 ...
 * @since 2.0
 */
public class MyLocalVariableTableParameterNameDiscoverer implements ParameterNameDiscoverer {
    ...
    private Map<Member, String[]> inspectClass(Class<?> clazz) {
        ...
        if (is == null) {
            ...
            System.out.println("Cannot find '.class' file for class [" + clazz +
        ...
        try {
            ...
            System.out.println("Exception thrown while reading '.class' file for class [" + clazz +
                    "] - unable to determine constructor/method parameter names" + ex);

        } catch (IllegalArgumentException ex) {
            System.out.println("ASM ClassReader failed to parse class file [" + clazz +
